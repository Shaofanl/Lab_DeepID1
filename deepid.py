...
def getMulticlassNet(lmdb, batch_size):
    ...
    n.conv4deepid = L.InnerProduct(n.conv4, num_output=320, weight_filler=dict(type='xavier'))
    n.pool3deepid = L.InnerProduct(n.pool3, num_output=320, weight_filler=dict(type='xavier'))
...
if __name__ == '__main__':
    ...
    runSolver(multiclass_solver, 'fc', N=20)
